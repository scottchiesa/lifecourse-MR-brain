...
sum age bmi tv gm area thick wm wmh thalamus hippocampus amygdala icv
tab sex
...
foreach outcome of local outcomes {
	local i = `i' + 1
	di "Outcome: `outcome'"
	eststo: regress `outcome' bmi_cat age i.sex i.education ses
	}
	esttab _all using obs_results_no_ed.csv, replace cells(b(fmt(3)) se(fmt(3)) p(fmt(3))) gaps lines nostar
