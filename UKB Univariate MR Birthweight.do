...
tab bw_thickn_beta
local snp_num = `r(N)'
mregger bw_thickn_beta BMI_beta [aw=1/(bw_thickn_se^2)], ivw 
lincom BMI_beta
local beta_ivw = `r(estimate)'
local se_ivw = `r(se)'
local p_ivw = `r(p)'
...
* MR-Egger method (multiplicative random effects)
mregger bw_thickn_beta BMI_beta [aw=1/(bw_thickn_se^2)] 
lincom slope
local beta_mregger_slope = `r(estimate)'
local se_mregger_slope = `r(se)'
local p_mregger_slope = `r(p)'
...
* Weighted median estimator
mrmedian bw_thickn_beta bw_thickn_se BMI_beta BMI_se, weighted seed(85674)
lincom beta
local beta_median = `r(estimate)'
local se_median = `r(se)'
local p_median = `r(p)'
...
* Weighted mode estimator
mrmodal bw_thickn_beta bw_thickn_se BMI_beta BMI_se, weighted seed(85674) 
lincom beta
local beta_mode = `r(estimate)'
local se_mode = `r(se)'
local p_mode = `r(p)'
...
local x=1
foreach estimator in ivw mregger_slope median mode {
	putexcel set "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\thickn_results", modify
	putexcel A1="Outcome" B1="No. SNPs" C1="Method" D1="Beta" E1="SE" F1="p"
	local x = `x'+1
...
* Is there evidence of heterogeneity in the genetic effects?
mregger bw_thickn_beta BMI_beta [aw=1/(bw_thickn_se^2)] , ivw fe heterogi
...
* Scatter plot of SNP-Outcome vs SNP-Exposure effects
twoway scatter bw_thickn_beta BMI_beta || function y = (`beta_ivw')*x, range(0.1 -0.055) lcol(ltblue) || ///
function y = (`beta_mregger_slope')*x + (`mregger_int'), lcol(blue) range(0.1 -0.055) || function y = (`beta_median')*x, lcol(mint) range(0.1 -0.055) || ///
function y = (`beta_mode')*x, lcol(green) range(0.1 -0.055) legend(order(2 "IVW" 3 "MR-Egger" 4 "Weighted median" 5 "Weighted mode")) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white))
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\thickn_scatter.png", replace							

* Forest plot of Wald ratios 
mrforest bw_thickn_beta bw_thickn_se BMI_beta BMI_se, ivid(id) effect(Wald ratio) ividlabel(SNP) models(2) xlabel(-1,-.5,0,.5,1) nonote ivwopts(fe) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white)) 
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\thickn_forest.png", replace

* Asymmetry
mrfunnel bw_thickn_beta bw_thickn_se BMI_beta BMI_se, metric(invse) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white))
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\thickn_funnel.png", replace

* Perform leave-one-out analysis to check for influential individual SNPs 
set more off
gen wald_ratio = bw_thickn_beta/BMI_beta
gen wald_ratio_se = bw_thickn_se/abs(BMI_beta)  
metaninf wald_ratio wald_ratio_se, label(namevar=id)
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\thickn_loo.png", replace
...
tab bw_logwmhn_beta
local snp_num = `r(N)'
mregger bw_logwmh_beta BMI_beta [aw=1/(bw_logwmhn_se^2)], ivw 
lincom BMI_beta
local beta_ivw = `r(estimate)'
local se_ivw = `r(se)'
local p_ivw = `r(p)'
...
* MR-Egger method (multiplicative random effects)
mregger bw_logwmhn_beta BMI_beta [aw=1/(bw_logwmhn_se^2)] 
lincom slope
local beta_mregger_slope = `r(estimate)'
local se_mregger_slope = `r(se)'
local p_mregger_slope = `r(p)'
...
* Weighted median estimator
mrmedian bw_logwmhn_beta bw_logwmhn_se BMI_beta BMI_se, weighted seed(85674)
lincom beta
local beta_median = `r(estimate)'
local se_median = `r(se)'
local p_median = `r(p)'
...
* Weighted mode estimator
mrmodal bw_logwmhn_beta bw_logwmhn_se BMI_beta BMI_se, weighted seed(85674) 
lincom beta
local beta_mode = `r(estimate)'
local se_mode = `r(se)'
local p_mode = `r(p)'
...
local x=1
foreach estimator in ivw mregger_slope median mode {
	putexcel set "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\logwmhn_results", modify
	putexcel A1="Outcome" B1="No. SNPs" C1="Method" D1="Beta" E1="SE" F1="p"
	local x = `x'+1
...
* Is there evidence of heterogeneity in the genetic effects?
mregger bw_logwmhn_beta BMI_beta [aw=1/(bw_logwmhn_se^2)] , ivw fe heterogi
...
* Scatter plot of SNP-Outcome vs SNP-Exposure effects
twoway scatter bw_logwmhn_beta BMI_beta || function y = (`beta_ivw')*x, range(0.1 -0.055) lcol(ltblue) || ///
function y = (`beta_mregger_slope')*x + (`mregger_int'), lcol(blue) range(0.1 -0.055) || function y = (`beta_median')*x, lcol(mint) range(0.1 -0.055) || ///
function y = (`beta_mode')*x, lcol(green) range(0.1 -0.055) legend(order(2 "IVW" 3 "MR-Egger" 4 "Weighted median" 5 "Weighted mode")) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white))
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\logwmhn_scatter.png", replace							

* Forest plot of Wald ratios 
mrforest bw_logwmhn_beta bw_logwmhn_se BMI_beta BMI_se, ivid(id) effect(Wald ratio) ividlabel(SNP) models(2) xlabel(-1,-.5,0,.5,1) nonote ivwopts(fe) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white)) 
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\logwmhn_forest.png", replace

* Asymmetry
mrfunnel bw_logwmhn_beta bw_logwmhn_se BMI_beta BMI_se, metric(invse) plotregion(fcolor(white) lcolor(white)) graphregion(fcolor(white) lcolor(white))
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\logwmhn_funnel.png", replace

* Perform leave-one-out analysis to check for influential individual SNPs 
set more off
gen wald_ratio = bw_logwmhn_beta/BMI_beta
gen wald_ratio_se = bw_logwmhn_se/abs(BMI_beta)  
metaninf wald_ratio wald_ratio_se, label(namevar=id)
graph export "Y:\UKB\MR\Data Files\Birthweight Outcomes\Results Files\logwmhn_loo.png", replace
