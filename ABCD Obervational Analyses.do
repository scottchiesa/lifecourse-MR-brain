...
gen thalamus = (smri_vol_scs_tplh + smri_vol_scs_tprh)/2
gen hippocampus = (smri_vol_scs_hpuslh + smri_vol_scs_hpusrh)/2
gen amygdala = (smri_vol_scs_amygdalalh + smri_vol_scs_amygdalarh)/2
